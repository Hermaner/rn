...
import { View, BackHandler, TouchableWithoutFeedback, TouchableOpacity } from 'react-native';
...
class GoodBusinessDetail extends base {
  constructor(props) {
    super(props);
  ...
  _renderTop() {
    ...
    return (
      <View style={styles.topView}>
        <CachedImage source={{ uri: `${detail.supplyImages[0].imgUrl}?imageView2/1/w/60` }} style={styles.mainImg} />
      ...
      <View style={styles.nameAPView}>
        ...
        <View style={styles.nameAddressView}>
          <Text style={styles.grayText}>
            {detail.sendProvinceName}{detail.sendCityName}{detail.sendDistrictName}</Text>
        </View>
      ...
      <View style={styles.maskerContent}>
        <View style={styles.maskerTop}>
          <View style={styles.maskerLeft}>
            <CachedImage source={{ uri: 'http://p11md08oo.bkt.clouddn.com/201812115032101.jpg?imageView2/2/w/600' }} style={styles.maskerImg} />
          </View>
        ...
        <View style={styles.maskerLink}>
          <CachedImage source={{ uri: 'http://p11md08oo.bkt.clouddn.com/201812115032101.jpg?imageView2/2/w/600' }} style={styles.maskerLinkImg} />
        </View>
...
GoodBusinessDetail.propTypes = {
  pop: PropTypes.func,
  navigation: PropTypes.object,
  push: PropTypes.func,
};
export default connect(null, { pop: popRoute, push: pushRoute })(GoodBusinessDetail);
