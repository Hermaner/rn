        ...
        <TFeedback
          content={
            <View style={styles.topPart}>
              <CachedImage style={styles.userImg} source={require('../app/resource/imgs/2.png')} />
    ...
    return (
      <View style={styles.goodsInfo}>
        <View style={styles.flexRow}>
          <CachedImage style={styles.goodsImg} source={{ uri: 'http://p11md08oo.bkt.clouddn.com/201812115032101.jpg?imageView2/2/w/600' }} />
          <View style={{ flex: 1 }}>
