...
import { CreateSupplyService, JudgeMemberIsPersonVerif } from '../../api';
    ...
    skus.forEach((item) => {
      if (item.itemIndex !== undefined) {
        ...
        purchaseItems.push({
          ...
          specName: item.specs[item.itemIndex].specName.toString(),
        });
      }
    });
