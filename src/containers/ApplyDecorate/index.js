...
class ApplyDecorate extends base {
  constructor(props) {
    super(props);
    this.state = {
      ...this.state,
  ...
  _renderStore() {
    const { decorationName, detail, businessHours, addressTitle, address } = this.state;
    return (
      <View style={styles.mainList}>
        <TitleItem text="店铺信息" />
        <View style={styles.listView}>
          ...
          <View style={styles.listRight}>
            <Input
              ...
              onChangeText={value => this.setState({ decorationName: value })}
            />
          </View>
        </View>
        <View style={styles.listView}>
      ...
      <Container>
        ...
        <Footer style={styles.footer}>
          <TOpacity
            ...
            onPress={this.AuthDecorationService}
          />
        </Footer>
...
ApplyDecorate.propTypes = {
  pop: PropTypes.func,
  push: PropTypes.func,
};
export default connect(null, { pop: popRoute, push: pushRoute })(ApplyDecorate);
