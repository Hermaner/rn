            ...
            <TFeedback
              content={
                <View style={styles.userNameView}>
                  <Text style={styles.nameText}>{info.bmMarketName}</Text>
                  <Text style={styles.nameText}>{info.address}</Text>
                </View>
              }
              onPress={() => this.props.push({ key: 'BmMarketDetail', params: { bmMarketId: global.bmMarketId } })}
            />
...
MgBmMarket.propTypes = {
  pop: PropTypes.func,
  push: PropTypes.func,
};
export default connect(null, { pop: popRoute, push: pushRoute })(MgBmMarket);
