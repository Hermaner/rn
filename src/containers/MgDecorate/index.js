            ...
            <TFeedback
              content={
                <View style={styles.userNameView}>
                  <Text style={styles.nameText}>{info.decorationName}</Text>
                  <Text style={styles.nameText}>{info.address}</Text>
                </View>
              }
              onPress={() => this.props.push({ key: 'DecorateDetail', params: { decorationId: global.decorationId } })}
            />
...
MgDecorate.propTypes = {
  pop: PropTypes.func,
  push: PropTypes.func,
};
export default connect(null, { pop: popRoute, push: pushRoute })(MgDecorate);
